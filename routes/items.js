...
export async function initItems() {
  await fetchCategoryRules(); // Load rules on init
  ...
  // Bulk upload and edit remain unchanged
...
// fetchItems and editItem remain largely the same, just adjust attribute display
